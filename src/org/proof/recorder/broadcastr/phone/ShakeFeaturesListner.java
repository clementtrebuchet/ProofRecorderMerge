...
public class ShakeFeaturesListner extends Service implements SensorEventListener {
	...
	BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
				...
				mSensorEventManager
						.unregisterListener(ShakeFeaturesListner.this);
				mSensorEventManager.registerListener(ShakeFeaturesListner.this,
