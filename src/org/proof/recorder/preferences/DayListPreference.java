...
public class DayListPreference extends ListPreference {
	private String separator;
	private static final String DEFAULT_SEPARATOR = "-";
	//private static final String LOG_TAG = "DayListPreference";
	private String checkAllKey = null;
	private boolean[] mClickedDialogEntryIndices;

	// Constructor
	public DayListPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public DayListPreference(Context context) {
		this(context, null);
	}
