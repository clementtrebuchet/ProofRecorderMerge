...
public class FragmentNotesEditor extends Fragment {
	
	private Bundle b;
	private static final String TAG = "FragmentNotesEditor";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(Settings.isDebug())
			Log.v(TAG, "PASS HERE"+c.getString(c.getColumnIndex(ProofDataBase.COLUMN_TITLE)));
		}
		c.close();
