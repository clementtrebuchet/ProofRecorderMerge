...
class LicenseValidator {
    ...
    public void verify(PublicKey publicKey, int responseCode, String signedData, String signature) {
        ...
        switch (responseCode) {
            case LICENSED:
            	Log.e(TAG, "Retour de Play = LICENSED");
            	handleResponse(Policy.LICENSED, data);
            	Settings.setNOT_LICENSED(false);
            	break;
            case LICENSED_OLD_KEY:
            	int limiterResponse = mDeviceLimiter.isDeviceAllowed(userId);
                handleResponse(limiterResponse, data);
                Log.e(TAG, "Retour de Play = LICENSED_OLD_KEY");
                Settings.setNOT_LICENSED(true);
                break;
            case NOT_LICENSED:
                handleResponse(Policy.NOT_LICENSED, data);
                Log.e(TAG, "Retour de Play = NOT_LICENSED");
                Settings.setNOT_LICENSED(true);
                break;
